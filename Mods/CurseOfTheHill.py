...
def bsGetGames():
    return [CurseOfTheHillGame]

class CurseOfTheHillGame(bs.TeamGameActivity):
    ...
    @classmethod
    def getName(cls):
        return 'Curse of the Hill'

    @classmethod
    def getDescription(cls,sessionType):
        return 'Secure the flag for a set length of time with a curse'
    ...
    def getInstanceDescription(self):
        return ('Secure the flag for ${ARG1} seconds with a curse.',self.settings['Hold Time'])
